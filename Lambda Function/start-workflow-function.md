...
This Lambda function receives event through EventBridge and checks if file is in `input` folder and in CSV format , then starts Glue Workflow.
    ...
    "Statement": [
        {
            ...
            "Resource":  [
                "arn:aws:logs:ap-south-1:183295412439:log-group:/aws/lambda/start_workflow_function:*"
            ]
        },
        {
            "Sid": "snsPublish",
