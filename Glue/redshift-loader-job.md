...
This Glue ETL job reads the Parquet file from the `output` folder and loads it into Redshift.
...
2. **Security Group:**
   * Inbound rule for Redshift and a self refferencing inbound rule.
...
### Connection creation:
   ...
   * After sucessfull creation Test your connection.
